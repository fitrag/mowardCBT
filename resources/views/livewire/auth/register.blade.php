    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 p-12 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center max-w-lg mx-auto">
            ...
            <h2 class="text-4xl font-bold text-white mb-6 leading-tight">
                Join Our<br/>Testing Platform
            </h2>
            <p class="text-xl text-indigo-100 mb-12 leading-relaxed">
                Create your account and start managing exams efficiently with our comprehensive system.
            </p>
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-4 group">
                    ...
                    <div>
                        <h3 class="text-white font-semibold text-lg">Easy Setup</h3>
                        <p class="text-indigo-200">Get started in minutes</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 group">
                    ...
                    <div>
                        <h3 class="text-white font-semibold text-lg">Secure Platform</h3>
                        <p class="text-indigo-200">Your data is protected</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 group">
                    ...
                    <div>
                        <h3 class="text-white font-semibold text-lg">Full Access</h3>
                        <p class="text-indigo-200">All features included</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="bg-white rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] ring-1 ring-slate-900/5 p-8 transition-all duration-300 hover:shadow-md">
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-sm text-slate-600">Sign up to get started with MowardCBT</p>
                </div>
