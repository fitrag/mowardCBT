                            ...
                            <li>
                                ...
                                <ul role="list" class="-mx-2 space-y-2">
                                    ...
                                    @else
                                        ...
                                        <li>
                                            <a href="{{ route('settings.index') }}" wire:navigate @click="sidebarOpen = false" class="{{ request()->routeIs('settings.*') ? 'bg-indigo-50 text-indigo-600 shadow-sm ring-1 ring-indigo-500/10' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }} group flex gap-x-3 rounded-xl p-3 text-sm leading-6 font-semibold transition-all duration-200">
                                                <svg class="{{ request()->routeIs('settings.*') ? 'text-indigo-600' : 'text-slate-400 group-hover:text-slate-600' }} h-6 w-6 shrink-0 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
