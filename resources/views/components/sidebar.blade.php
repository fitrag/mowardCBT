                ...
                <li>
                    ...
                    <ul role="list" class="-mx-2 space-y-2">
                        @if(auth()->user()->role->value === 'admin')
                            ...
                            <li>
                                <x-sidebar-link route="tests.index" activePattern="tests.*" label="Tests">
                                    <x-slot name="icon">
                            ...
                            <li>
                                <x-sidebar-link route="tokens.index" activePattern="tokens.*" label="Tokens">
                                    <x-slot name="icon">
                            ...
                            <li>
                                <x-sidebar-link route="reports.test-results" activePattern="reports.*" label="Reports">
                                    <x-slot name="icon">
